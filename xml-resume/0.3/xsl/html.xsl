...
<xsl:stylesheet version="1.0"
                ...
                xmlns:r="http://derwinmcgeary.github.io/xml-resume/0.3">
    ...
    <xsl:template match="r:header">
        <div class="row header">
            ...
            <span class="col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xs-3 offset-sm-1 offset-md-1 offset-lg-1">
